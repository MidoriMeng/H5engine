var MAP;
(function (MAP) {
    class MapService extends engine.DisplayObjectContainer {
        constructor() {
            super();
        ...
        loadNPCs() {
            ...
            var npc_001 = new NPC("001", "npc1", appearances, DIRECTION.SOUTH, "Actor1.jpg");
            npc_001.setPosition(new Vector2_p48(5, 5));
            var npc_002 = new NPC("002", "npc2", appearances, DIRECTION.SOUTH, "Actor1.jpg");
